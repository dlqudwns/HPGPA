function [f,df] = objFunctionSECosMixLocal(theta,K,covfunc,X,Y,tau1,tau2,missingInd)
...
[Ct,Rt,Qt,dCt,dRt,dQt] = ...
    getParamsSECosMixLocal(covfunc,covhyp,mu,vary,X,tau1,tau2,noblks,missingInd);
...
smoothing = 1;
verbose = 0;
[f,df] = kalmanVarLocal(Ct,Qt,Rt,x0,P0,yKalman,verbose,...
